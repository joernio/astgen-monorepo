...
| --------------- | ------------------------------------------ |------------------------| -------- | -------------- |
| ABAP            | [`abap-astgen/`](./abap-astgen/)           | @abaplint/core         | Active   | [![Release](https://img.shields.io/github/v/release/joernio/astgen-monorepo?filter=abap-astgen%2F*&label=)](https://github.com/joernio/astgen-monorepo/releases?q=abap-astgen)              |
...
| Ruby            | [`ruby-astgen/`](./ruby-astgen/)           | `prism` / `parser` gem | Active   | [![Release](https://img.shields.io/github/v/release/joernio/astgen-monorepo?filter=ruby-astgen%2F*&label=)](https://github.com/joernio/astgen-monorepo/releases?q=ruby-astgen) |
